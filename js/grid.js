document.addEventListener("DOMContentLoaded", function () {
    const numberOfImages = 100; // Adjust this number to match your total number of images
    ...
    for (let i = 1; i <= numberOfImages; i++) {
        ...
        const randomY = Math.random() * (containerHeight - 100); // 100 is the assumed image height
